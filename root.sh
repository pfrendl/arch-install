...
# window manager, compositor, status bar updates, and key events
pacman --noconfirm -S xorg-server xorg-xinit libxft libxinerama xorg-xsetroot sxhkd bspwm, picom
